...
val sampleProductList = listOf(
    Product(
        ...
        name = "Apples",
        iconUri = "",
        sampleCategoryList.find { it.id == 1 }!!,
        deletable = false,
    ),
    Product(
        id = 2,
        name = "Bread",
        iconUri = "",
        sampleCategoryList.find { it.id == 2 }!!,
        deletable = false,
    ),
    Product(
        id = 3,
        name = "Milk",
        iconUri = "",
        sampleCategoryList.find { it.id == 3 }!!,
        deletable = false,
    ),
    Product(
        id = 4,
        name = "Chicken",
        iconUri = "",
        sampleCategoryList.find { it.id == 4 }!!,
        deletable = false,
    ),
    Product(
        id = 5,
        name = "Fish",
        iconUri = "",
        sampleCategoryList.find { it.id == 5 }!!,
        deletable = false,
    )
)
